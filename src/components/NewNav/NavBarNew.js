...
const NavBarNew = () => {
  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
      ...
      {isMenuOpen && windowWidth <= 850 && (
        <div className={styles.mobileMenu}>
          {menuItems.map((item, index) => (
            ...
            <div classsName={styles.center}><img className={styles.image} src={logo} alt="ענבל רוזנפלד לוגו"/></div>
        </div>
      )}
      {windowWidth > 850 && (
      ...
      <a href="https://www.instagram.com/inbal_rozenfeld_academy/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
