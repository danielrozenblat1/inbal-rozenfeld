...
return <>
<div className={props.scrolled?styles.descriptionP:styles.description}>תמיד חלמת להיות עצמאית? לנהל את הזמן שלך ולהפוך את החלום שלך לעסק מצליח ורווחי ? האקדמיה שלי כאן כדי להראות לך את הדרך!</div>
